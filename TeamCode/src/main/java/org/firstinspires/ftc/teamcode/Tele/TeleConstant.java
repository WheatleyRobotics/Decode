...
public class TeleConstant {
    public static final double startingHoodPos = 0.39;
    public static double ildeRPM = 0.3;

    public static final int bumperUpRPM = 53; //55
    ...
    public static final int closeShotRPM = 70; //55
    ...
    public static final int midShotRPM = 76; //75
