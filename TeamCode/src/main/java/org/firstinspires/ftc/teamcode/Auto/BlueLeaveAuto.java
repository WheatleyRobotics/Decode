...
@Autonomous(name = "Shoot And Leave Blue")
public class BlueLeaveAuto extends OpMode {
    ...
    private final Pose startingPose =
            new Pose(25.855524079320112, 130.38810198300283, Math.toRadians(143));

    private final Pose intakePose =
            new Pose(72.45892351274789, 132.60906515580734, Math.toRadians(143));
